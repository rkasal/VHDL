...
HD_PWD='C:/Users/Kasal/Desktop/xilinx_example/debounce/debounce.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log debounce.vds -m64 -mode batch -messageDb vivado.pb -notrace -source debounce.tcl
